...
const Services = () => {
    ...
    const servicesData = [
        {
            title: 'Advertising',
            description: 'We turn nold ideas into powerful digital solutions that connect, engage...',
    ...
    <motion.div
     ...
     id='services' className='relative flex flex-col items-center gap-7 px-4 sm:px-12
        ...
        <img src={assets.bgImage2} alt='' className=' absolute -top-110 -left-70
         ...
         execution , we craft digital solutions that move your business forword.'/>
