        ...
        <div className=' flex justify-between lg:items-center
         max-lg:flex-col gap-10'>
            ...
            className=' space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                  <img src={theme === 'dark' ? assets.logo_dark: assets.logo} className=' w-32 sm:w-44' alt=''></img>
                        <p className=' max-w-md'>From strategy to executon, we craft digital solutions 
            ...
            className=' text-gray-600 dark:text-gray-400'>
                ...
                <div className=' flex gap-2 text-sm'>
                    ...
                    className=' w-full p-3 text-sm outline-none rounded dark:text-gray-200
                     bg-transparent border border-gray-300 dark:border-gray-500'></input>
        ...
        className=' pb-6 text-sm text-gray-500 flex justify-center 
         sm:justify-between gap-4 flex-wrap'>
            ...
            <div className=' flex items-center justify-between gap-4'> 
                ...
                <img src={assets.instagram_icon} alt=''></img>
