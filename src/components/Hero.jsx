     ...
     lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700
      dark:text-white'>
        ...
        className=' text-4xl sm:text-5xl md:text-6xl xl:text-[84px]
          font-medium xl:leading-[95px] max-w-5xl'>Turning imagination into <span 
        ...
        <motion.p
          ...
          max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into 
